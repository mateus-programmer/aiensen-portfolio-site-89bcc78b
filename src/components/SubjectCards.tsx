...
export const subjectsBySemester: Record<string, SubjectInfo[]> = {
  ...
  "1s-2026": [
    {
      name: "Sistemas de Informação e Sociedade",
      slug: "sistemas-informacao-sociedade",
      code: "SIS.01",
      accentHsl: "200 95% 60%",
      icon: Users,
      shortLabel: "INFO_SOC",
      description: "Impacto social da TI, ética digital e transformação digital.",
      tag: "Sistemas de Informação e Sociedade",
    },
    {
      name: "Desenvolvimento Web em HTML5, CSS, JavaScript e PHP",
      slug: "desenvolvimento-web",
      code: "WEB.02",
      accentHsl: "25 95% 55%",
      icon: Globe,
      shortLabel: "WEB_DEV",
      description: "Frontend responsivo, backend PHP e integração full-stack.",
      tag: "Desenvolvimento Web",
    },
    {
      name: "Paradigmas de Linguagens de Programação em Python",
      slug: "paradigmas-python",
      code: "PAR.03",
      accentHsl: "150 85% 50%",
      icon: Code2,
      shortLabel: "PY_PARADIGM",
      description: "Funcional, orientado a objetos e procedural com Python.",
      tag: "Paradigmas Python",
    },
    {
      name: "Estruturas de Dados em C",
      slug: "estruturas-dados-c",
      code: "EDC.04",
      accentHsl: "35 90% 55%",
      icon: FileCode,
      shortLabel: "C_DATA",
      description: "Listas, pilhas, filas, árvores e algoritmos de busca em C.",
      tag: "Estruturas de Dados em C",
    },
    {
      name: "Modelagem de Sistemas em UML",
      slug: "modelagem-sistemas-uml",
      code: "UML.05",
      accentHsl: "280 90% 65%",
      icon: Layers,
      shortLabel: "UML_SYS",
      description: "Diagramas de classes, casos de uso, sequência e componentes.",
      tag: "Modelagem UML",
    },
  ],
};
